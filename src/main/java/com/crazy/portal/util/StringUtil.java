...
public class StringUtil {
	...
	public static boolean equals(Number num, String str2) {
		...
		return String.valueOf(num).equals(str2);
	}
	...
	public static String join(Object[] array, String separator) {
		...
		if(arraySize == 0){
			...
			int valueA = (array[0] == null) ? 16 : array[0].toString().length();
			int valueB = StringUtils.isEmpty(separator) ? 0 : separator.length();
			bufSize = arraySize * (valueA + valueB);
		}
	 ...
	 * @return
	 */
	public static Long[] StringtoLong(String str, String split) {
