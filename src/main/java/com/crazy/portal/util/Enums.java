...
public class Enums {
    ...
    public enum BI_FUNCTION_CODE{
        //交付管理 - 收货
        CHECK_INVENTORY_IMPORT_FILE,SAVE_INVENTORY_IMPORT_FILE,DELETE_INVENTORY_CASE,UPDATE_INVENTORY_IMPORT_FILE,
        //交付管理 - 出货
        CHECK_SALES_IMPORT_FILE,SAVE_SALES_IMPORT_FILE,DELETE_SALES_CASE,UPDATE_SALES_IMPORT_FILE,
        //预测管理
        CHECK_FORECAST_IMPORT_DATA,INSERT_FORECAST_IMPORT_DATA,UPDATE_FORECAST_IMPORT_DATA,DELETEFORECAST;
    }
