...
public class ErrorCodes {
    ...
    public enum BusinessEnum implements ErrorInfo {
        ...
        CUSTOMER_IS_NOT_BB(50016,"非报备客户或没有对应的客户价格",""),
        ...
        REBATE_FILE_IS_NOT_FOUND(70104, "该文件不存在，请选择文件后上传", ""),
        ...
        ORDER_NOT_EXISTS_PRODUCT_ID(900014, "附件行: 平台物料号不存在", ""),
        ORDER_EMPTY_PRODUCT_ID(900015, "附件行: 物料号不能为空", ""),
        ORDER_EMPTY_PLATFORM(900016, "附件行: 平台不能为空", ""),
        ORDER_EMPTY_NUM(900017, "附件行: 数量不能为空", ""),
        ORDER_EMPTY_EXPECTEDDELIVERYMONTH(900018, "附件行: 期望交货月份不能为空", ""),
        ...
        ORDER_INVALID_PRODUCT(900024,"附件行: 物料号[%s]无效",""),
        ORDER_EMPTY_PRODUCT(900025,"附件行: 物料号不能为空",""),
