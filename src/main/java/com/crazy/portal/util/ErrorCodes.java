...
public class ErrorCodes {
    ...
    public enum BusinessEnum implements ErrorInfo {
        ...
        HANDOVER_FILE_DATA_IS_NULL(40020, "数据不能为空，请重新输入", ""),
        ...
        AGENCY_RATE_UPLOAD_FILE_IS_NULL_ERROR(70107,"上传文件不能为空，请选择文件",""),
        AGENCY_RATE_UPLOAD_FILE_CONTENT_IS_NULL_ERROR(70108,"上传文件内容不能为空，请填写后重新上传",""),
        AGENCY_RATE_APPROVE_RECORD_IS_REQUIRED(70109,"请先选择代理费率记录再进行审批",""),
        //商务管理-保差退
        BUSINESS_IDR_TYPE_IS_REQUIRED(70002, "类型不能为空，请重新选择", ""),
        BUSINESS_IDR_FILE_TYPE_IS_REQUIRED(70003, "文件类型不能为空，请重新选择", ""),
        BUSINESS_IDR_FILE_IS_REQUIRED(70004, "文件内容不能为空，请填写后重新上传", ""),
        BUSINESS_IDR_ID_IS_REQUIRED(70005, "ID不能为空，请输入后重新提交", ""),
        BUSINESS_IDR_INFO_IS_NOT_FOUND(70006, "该信息不存在，请联系管理员", ""),
        BUSINESS_IDR_STATUS_NOT_APPROVAL(70007, "该申请还未通过审核，请审核通过后再进行上传", ""),
        BUSINESS_IDR_SUBMIT_RESULT_IS_NULL(70008, "提交审批返回结果为空，请联系管理员", ""),
        BUSINESS_IDR_SUBMIT_RESULT_IS_FAIL(70009, "提交审批返回失败，请联系管理员", ""),
        BUSINESS_IDR_APPROVAL_ORDER_NO_NOT_FOUND(70010, "审批结果同步：orderNo不存在", ""),
        BUSINESS_IDR_APPROVAL_DATE_PARSE_EXCEPTION(70011, "保差退提交审核：不是合法的日期格式", ""),
        BUSINESS_IDR_APPROVAL_API_EXCEPTION(70012, "保差退提交审核：接口异常", ""),
        BUSINESS_IDR_APPROVAL_IDR_INFO_NOT_FOUND(70013, "审批结果同步：保差退信息不存在", ""),
        BUSINESS_IDR_UPLOAD_FILE_IS_NULL(70014, "上传文件为空，请选择文件", ""),
        //商务管理-客户rebate
        REBATE_RECORD_NOT_FOUND(70101, "该记录不存在，请核对后重新提交", ""),
        REBATE_SURPLUS_AMOUNT_TOO_LARGE(70103, "释放金额不能大于rebate金额，请重新填写", ""),
        REBATE_FILE_IS_NOT_FOUND(70104, "该文件不存在，请联系管理员", ""),
        REBATE_ITEM_ID_IS_NULL(70105, "RebateItemId不能为空，请重新选择", ""),
        REBATE_EXECUTOR_EMAIL_IS_NOT_FOUND(70106, "Rebate执行人邮箱为空，请联系管理员", ""),
        REBATE_SEND_EMAIL_EXCEPTION(70107, "发送确认函异常，请联系管理员", ""),
        REBATE_ITEM_CONFIRM_FILE_UPLOAD_EXCEPTION(70108, "上传确认文件必须是代理商", ""),
        REBATE_ITEM_FINISHED_EXCEPTION(70109, "该Rebate已完结，不可上传文件", ""),
        REBATE_ITEM_DL_PROHIBIT_UPLOAD_EXCEPTION(70110, "完结文件不可由代理商上传", ""),
        REBATE_ZREXECUTEDATE_IS_REQUIRED(70111, "执行时间必须选择", ""),
        REBATE_UPLOAD_FILE_IS_NULL(70112, "上传文件为空，请选择文件", ""),
        REBATE_MODIFY_REMARK_CONTENT_IS_NULL(70113, "备注内容不能为空，请重新输入", ""),
        //产品管理
        ...
        ORDER_LINE_FILE_ERROR(900010, "附件行中参数格式不正确", ""),
        ORDER_EMPTY_PRICE_DATE(900011, "定价日期不能为空", ""),
        ORDER_APPLY_ORDER_NOT_FOUND(900012, "订单信息不存在", ""),
        ORDER_NO_DELETE(900013,"非驳回订单不允许删除",""),
        ORDER_NOT_EXISTS_PRODUCT_ID(900014, "附件行中平台物料号不存在", ""),
        ORDER_EMPTY_PRODUCT_ID(900015, "附件行中物料号不能为空", ""),
        ORDER_EMPTY_PLATFORM(900016, "附件行中平台不能为空", ""),
        ORDER_EMPTY_NUM(900017, "附件行中数量不能为空", ""),
        ORDER_EMPTY_EXPECTEDDELIVERYMONTH(900018, "附件行中期望交货月份不能为空", ""),
        ...
        ORDER_INVALID_PRODUCT(900024,"附件行中物料号[%s]无效",""),
        ORDER_EMPTY_PRODUCT(900025,"附件行中物料号不能为空",""),
        ORDER_EMPTY_CUSTABBREVIATION(900026,"附件行中客户简称不能为空",""),
        ORDER_INVALID_CUSTABBREVIATION(900027,"附件行中客户不存在",""),
        ORDER_NO_MAPPING_CUST(900028,"附件行中物料[%s]、客户[%s]匹配不出价格",""),
