...
public class ErrorCodes {
    ...
    public enum BusinessEnum implements ErrorInfo {
        ...
        FORECAST_BI_SERVER_EXCEPTION(40006, "BI服务异常，请联系管理员", ""),
        FORECAST_BI_RESPONSE_EXCEPTION(40007, "BI处理结果解析异常，请联系管理员", ""),
        FORECAST_BI_DELETE_FAIL(40008, "数据删除失败，请联系管理员", ""),
        FORECAST_BI_CHECK_RESPONSE_ID_NOT_EXISTS(40009, "BI Excel数据 - Portal ID未正确返回", ""),
        FORECAST_NOT_FOUND_CUSTOMER_INFO(40010, "请填写正确的客户简称信息", ""),
        FORECAST_AGENCY_INFO_ERROR(40011, "请使用代理商身份进行操作", ""),
        FORECAST_SD_DATA_COMMIT_ERROR(40012, "预测汇总数据提交BI校验不通过", ""),
        FORECAST_BI_ID_NOT_EXISTS(40013, "BI数据ID无法匹配数据，请检查数据", ""),
        FORECAST_AGENCY_MATCH_ERROR(40014, "无法匹配代理商信息，请联系管理员", ""),
        ...
        ORDER_PENDING_ORDER(90004, "请等待该订单审批结束后再操作", ""),
