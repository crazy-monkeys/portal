...
import com.crazy.portal.dao.task.ScheduleJobMapper;
import com.crazy.portal.entity.task.ScheduleJob;
import com.crazy.portal.util.CommonEnum;
...
public class ScheduleJobService {
	...
	public void delUpdate(ScheduleJob scheduleJob) throws Exception{
		//数据库直接更新即可
        scheduleJob.setUpdateDate(new Timestamp(System.currentTimeMillis()));
