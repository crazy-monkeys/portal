package com.crazy.portal.service.task;

import com.crazy.portal.dao.task.ScheduleMonitorMapper;
import com.crazy.portal.entity.task.ScheduleMonitor;
import com.crazy.portal.util.ScheduleEnum;
import com.crazy.portal.util.ScheduleUtils;
...
public class ScheduleMonitorService {
	...
	public void processBefore(String scheduleCode) {
		...
		scheduleMonitor.setBeginTime(new Timestamp(System.currentTimeMillis()));
		try {
	...
	public void processAfter(String scheduleCode) {
		...
		scheduleMonitor.setEndTime(new Timestamp(System.currentTimeMillis()));
