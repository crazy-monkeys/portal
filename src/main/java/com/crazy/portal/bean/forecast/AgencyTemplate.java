...
public class AgencyTemplate extends BaseRowModel {
    ...
    @ExcelProperty(index = 4, value = "预测类型")
...
//    @ExcelProperty(index = 7, value = "虚拟料号")
    ...
    @ExcelProperty(index = 8, value = "客户专货库存截止日期")
    ...
    @ExcelProperty(index = 11, value = "上次销售预测1")
    private String lastWriteOne;

    @ExcelProperty(index = 12, value = "本次代理填写值1")
