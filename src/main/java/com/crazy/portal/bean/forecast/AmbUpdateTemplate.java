...
public class AmbUpdateTemplate {
    ...
    @ExcelProperty(index = 32, value = "上次销售预测2")
    private String lastWriteTwo;

    @ExcelProperty(index = 33, value = "本次代理填写值2")
    ...
    @ExcelProperty(index = 41, value = "上次销售预测3")
    private String lastWriteThree;

    @ExcelProperty(index = 42, value = "本次代理填写值3")
    ...
    @ExcelProperty(index = 50, value = "上次销售预测4")
    private String lastWriteFour;

    @ExcelProperty(index = 51, value = "本次代理填写值4")
    ...
    @ExcelProperty(index = 59, value = "上次销售预测5")
    private String lastWriteFive;

    @ExcelProperty(index = 60, value = "本次代理填写值5")
    ...
    @ExcelProperty(index = 68, value = "上次销售预测6")
    private String lastWriteSix;

    @ExcelProperty(index = 69, value = "本次代理填写值6")
    ...
    @ExcelProperty(index = 76, value = "PO价格")
    private String poPrice;

    @ExcelProperty(index = 77, value = "虚拟料号")
