...
@Data
public class AgencyErrorTemplate extends BaseRowModel {
    ...
    @ExcelProperty(index = 12, value = "上次填写值1")
    private String lastWriteOne;

    @ExcelProperty(index = 13, value = "本次填写值1")
    ...
    @ExcelProperty(index = 17, value = "上次填写值2")
    private String lastWriteTwo;

    @ExcelProperty(index = 18, value = "本次填写值2")
    ...
    @ExcelProperty(index = 22, value = "上次填写值3")
    private String lastWriteThree;

    @ExcelProperty(index = 23, value = "本次填写值3")
    ...
    @ExcelProperty(index = 27, value = "上次填写值4")
    private String lastWriteFour;

    @ExcelProperty(index = 28, value = "本次填写值4")
    ...
    @ExcelProperty(index = 32, value = "上次填写值5")
    private String lastWriteFive;

    @ExcelProperty(index = 33, value = "本次填写值5")
    ...
    @ExcelProperty(index = 37, value = "上次填写值6")
