...
public class SdUpdateTemplate extends BaseRowModel {
    ...
    @ExcelProperty(index = 23, value = "首代Buffer2")
    ...
    @ExcelProperty(index = 28, value = "首代Buffer3")
    ...
    @ExcelProperty(index = 33, value = "首代Buffer4")
    ...
    @ExcelProperty(index = 38, value = "首代Buffer5")
    ...
    @ExcelProperty(index = 43, value = "首代Buffer6")
