...
/**
 * <p>BO_ExtendCustomerQuery_EXT_Cust_AssetInfoAssetInfoSimpleByConfirmation complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="BO_ExtendCustomerQuery_EXT_Cust_AssetInfoAssetInfoSimpleByConfirmation"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="BO_ExtendCustomerSAP_UUID" type="{http://sap.com/xi/Common/DataTypes}UUID" minOccurs="0"/&gt;
 *         &lt;element name="BO_ExtendCustomerCustomerID" type="{http://sap.com/xi/AP/Common/GDT}BusinessPartnerInternalID" minOccurs="0"/&gt;
...
@XmlType(name = "BO_ExtendCustomerQuery_EXT_Cust_AssetInfoAssetInfoSimpleByConfirmation", propOrder = {
    "boExtendCustomerSAPUUID",
    "boExtendCustomerCustomerID",
    "sapuuid",
    "year",
    "yearName",
    "season",
...
public class BOExtendCustomerQueryEXTCustAssetInfoAssetInfoSimpleByConfirmation {

    @XmlElement(name = "BO_ExtendCustomerSAP_UUID")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String boExtendCustomerSAPUUID;
    @XmlElement(name = "BO_ExtendCustomerCustomerID")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String boExtendCustomerCustomerID;
     ...
     *     
     */
    public String getBOExtendCustomerSAPUUID() {
        return boExtendCustomerSAPUUID;
    }

    /**
     * 设置boExtendCustomerSAPUUID属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setBOExtendCustomerSAPUUID(String value) {
        this.boExtendCustomerSAPUUID = value;
    }

    /**
     * 获取boExtendCustomerCustomerID属性的值。
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getBOExtendCustomerCustomerID() {
        return boExtendCustomerCustomerID;
    }

    /**
     * 设置boExtendCustomerCustomerID属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setBOExtendCustomerCustomerID(String value) {
        this.boExtendCustomerCustomerID = value;
    }
