...
/**
 * <p>AppointmentActivityMaintainRequestBundleOrganizerParty complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="AppointmentActivityMaintainRequestBundleOrganizerParty"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AppointmentActivityMaintainRequestBundleOrganizerParty", namespace = "http://sap.com/xi/A1S/Global", propOrder = {
    "businessPartnerInternalID",
    "employeeID",
    "emailURI",
    "name"
})
public class AppointmentActivityMaintainRequestBundleOrganizerParty {
