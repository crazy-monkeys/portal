...
/**
 * <p>BO_ExtendCustomerquerySalesDataSalesDataSimpleByRequestSelectionBySAP_SystemAdministrativeDataLastChangeDateTime complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="BO_ExtendCustomerquerySalesDataSalesDataSimpleByRequestSelectionBySAP_SystemAdministrativeDataLastChangeDateTime"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "BO_ExtendCustomerquerySalesDataSalesDataSimpleByRequestSelectionBySAP_SystemAdministrativeDataLastChangeDateTime", propOrder = {
    "inclusionExclusionCode",
    "intervalBoundaryTypeCode",
    "lowerBoundaryLastChangeDateTime",
    "upperBoundaryLastChangeDateTime"
})
public class BOExtendCustomerquerySalesDataSalesDataSimpleByRequestSelectionBySAPSystemAdministrativeDataLastChangeDateTime {
