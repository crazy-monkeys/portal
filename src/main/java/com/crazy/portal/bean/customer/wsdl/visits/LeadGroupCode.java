 ...
 * 
 * 
 * <p>LeadGroupCode complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="LeadGroupCode"&gt;
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;http://sap.com/xi/AP/Common/GDT&gt;LeadGroupCode.Content"&gt;
...
@XmlType(name = "LeadGroupCode", propOrder = {
    "value"
})
public class LeadGroupCode {
