 ...
 * 
 * 
 * <p>ActivityInitiatorCode complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ActivityInitiatorCode"&gt;
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;http://sap.com/xi/AP/Common/GDT&gt;ActivityInitiatorCode.Content"&gt;
...
@XmlType(name = "ActivityInitiatorCode", propOrder = {
    "value"
})
public class ActivityInitiatorCode {
