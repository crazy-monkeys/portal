...
/**
 * <p>EncryptedFormattedAddress complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="EncryptedFormattedAddress"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="FourthLineDescription" type="{http://sap.com/xi/AP/Common/GDT}LANGUAGEINDEPENDENT_ENCRYPTED_MEDIUM_Description" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "EncryptedFormattedAddress", namespace = "http://sap.com/xi/AP/Common/GDT", propOrder = {
    "firstLineDescription",
    "secondLineDescription",
    "thirdLineDescription",
    "fourthLineDescription"
})
public class EncryptedFormattedAddress {
