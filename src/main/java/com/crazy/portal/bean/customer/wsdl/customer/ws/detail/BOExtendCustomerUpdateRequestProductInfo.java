...
/**
 * <p>BO_ExtendCustomerUpdateRequestProductInfo complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="BO_ExtendCustomerUpdateRequestProductInfo"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "BO_ExtendCustomerUpdateRequestProductInfo", propOrder = {
    "sapuuid",
    "productCode",
    "businessUnit",
    "currentyear",
...
public class BOExtendCustomerUpdateRequestProductInfo {
