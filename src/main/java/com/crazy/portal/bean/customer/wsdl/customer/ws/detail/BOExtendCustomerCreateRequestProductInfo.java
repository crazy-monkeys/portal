...
/**
 * <p>BO_ExtendCustomerCreateRequestProductInfo complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="BO_ExtendCustomerCreateRequestProductInfo"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "BO_ExtendCustomerCreateRequestProductInfo", propOrder = {
    "productCode",
    "businessUnit",
    "currentyear",
    "currentmonth",
...
public class BOExtendCustomerCreateRequestProductInfo {
