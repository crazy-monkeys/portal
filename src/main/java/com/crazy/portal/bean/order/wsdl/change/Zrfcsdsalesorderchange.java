...
@Slf4j
public class Zrfcsdsalesorderchange {

    public Zrfcsdsalesorderchange() {
    }

    public Zrfcsdsalesorderchange(ZrfcsdsalesorderchangeBody body) {
        this.body = body;
    }
    ...
    private ZrfcsdsalesorderchangeBody body;
}
