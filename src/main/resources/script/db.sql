...
insert into `portal`.`t_resource` ( `active`, `create_time`, `create_user_id`, `icon_class`, `parent_id`, `resource_desc`, `resource_name`, `resource_order`, `resource_type`, `resource_url`, `update_time`, `update_user_id`, `permission_prefix_url`) values ( '1', '2019-06-23 05:37:53', '1', '#', '16', '#', '询价单', '99', '1', '/view/price/ourInquiry.html', '2019-06-23 05:37:53', '1', '#');
insert into `portal`.`t_resource` ( `active`, `create_time`, `create_user_id`, `icon_class`, `parent_id`, `resource_desc`, `resource_name`, `resource_order`, `resource_type`, `resource_url`, `update_time`, `update_user_id`, `permission_prefix_url`) values ( '1', '2019-06-23 05:38:30', '1', '#', '16', '#', '询价单审批', '99', '1', '/view/price/ourInquiryApproval.html', '2019-06-23 05:38:30', '1', '#');
insert into `portal`.`t_resource` ( `active`, `create_time`, `create_user_id`, `icon_class`, `parent_id`, `resource_desc`, `resource_name`, `resource_order`, `resource_type`, `resource_url`, `update_time`, `update_user_id`, `permission_prefix_url`) values ( '1', '2019-06-23 05:38:57', '1', '#', '16', '#', '下单价申请', '99', '1', '/view/price/orderPriceApply.html', '2019-06-23 05:38:57', '1', '#');
insert into `portal`.`t_resource` ( `active`, `create_time`, `create_user_id`, `icon_class`, `parent_id`, `resource_desc`, `resource_name`, `resource_order`, `resource_type`, `resource_url`, `update_time`, `update_user_id`, `permission_prefix_url`) values ( '1', '2019-06-23 05:39:23', '1', '#', '16', '#', '代理费率维护', '99', '1', '/view/price/agentRate.html', '2019-06-23 05:39:23', '1', '#');
insert into `portal`.`t_resource` ( `active`, `create_time`, `create_user_id`, `icon_class`, `parent_id`, `resource_desc`, `resource_name`, `resource_order`, `resource_type`, `resource_url`, `update_time`, `update_user_id`, `permission_prefix_url`) values ( '1', '2019-06-23 05:39:44', '1', '#', '16', '#', '代理费率查询', '99', '1', '/view/price/agentRateQuery.html', '2019-06-23 05:39:44', '1', '#');
