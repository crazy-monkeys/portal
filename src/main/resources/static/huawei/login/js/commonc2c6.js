...
function rejectHijacking(isEnabled){
    if(isEnabled){
		if(top!=self){   
		     try{
			     if((document.referrer=='https://uniportal.huawei.com/' || document.referrer=='http://uniportal.huawei.com/') || (document.referrer.indexOf('huawei.com')==-1 && document.referrer.indexOf('huaweidevice.com')==-1)){
